/* $Id: spooler.h,v 1.3 1993/01/30 02:53:07 johnr Exp $ */
...
#define SPL_TESTPG		4				/* generated from testpage */
...
/*
 *	$Log: spooler.h,v $
 * Revision 1.3  1993/01/30  02:53:07  johnr
 * JR:  Added a define for SPL_TESTPG.  This entry denotes the data in the
 *      spooler is coming from the testpage process.
 *
 * Revision 1.2  1992/12/22  18:50:31  johnr
 * JR:  I added IPADDR as an equivalent typedef to the IP address typedef
 *      defined by network.h.  This was done so that spooler.c and despool.c
 *      did not have to include network.h.  After all, there is no real
 *      reason that spooler/despooler needs to be dependent on the networking
 *      includes.  The only item both files need is the IP address typedef, and
 *      it makes better sense to include it in spooler.h.
 *
 * Revision 1.1  1992/11/11  16:51:27  johnr
